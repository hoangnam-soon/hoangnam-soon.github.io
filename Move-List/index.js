$(document).ready(function(){
    ...
    function renderTask(idDom, arrTask) {
    ...
    renderTask('#col-1', taskReady)
    renderTask('#col-2', inProgress)
    renderTask('#col-3', needsReview)
    renderTask('#col-4', done)
    ...
    $( "#add-button" ).click(function() {
        ...
        // update lai dom
        renderTask('#col-1', newTanksReady)
    });
    ...
    function onEndCheck(evt) {
        ...
        switch (idFrom) {
            ...
            case 'col-2':
                ...
                itemTemplate = [...newArrinProgress][index]
            ...
            case 'col-3':
                ...
                itemTemplate = [...newArrneedsReview][index]
